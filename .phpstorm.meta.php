...
'scout.algolia.id','scout.algolia.secret','scout.meilisearch.host','scout.meilisearch.key','scout.meilisearch.index-settings',
...
'session.same_site','session.partitioned','typescript-transformer.auto_discover_types','typescript-transformer.collectors','typescript-transformer.transformers',
...
'sanctum.csrf-cookie','laravel-folio',
'storage.local',);
