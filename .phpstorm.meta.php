...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'constants.cars.0.ar' => 'string',
            'constants.cars.0.en' => 'string',
            'constants.cars.1.ar' => 'string',
            'constants.cars.1.en' => 'string',
            'constants.cars.2.ar' => 'string',
            'constants.cars.2.en' => 'string',
            'constants.cars.3.ar' => 'string',
            'constants.cars.3.en' => 'string',
            'constants.cars.4.ar' => 'string',
            'constants.cars.4.en' => 'string',
            'constants.cars.5.ar' => 'string',
            'constants.cars.5.en' => 'string',
            'constants.cars.6.ar' => 'string',
            'constants.cars.6.en' => 'string',
            'constants.cars.7.ar' => 'string',
            'constants.cars.7.en' => 'string',
            'constants.cars.8.ar' => 'string',
            'constants.cars.8.en' => 'string',
            'constants.cars.9.ar' => 'string',
            'constants.cars.9.en' => 'string',
            'constants.cars.10.ar' => 'string',
            'constants.cars.10.en' => 'string',
            'constants.cars.11.ar' => 'string',
            'constants.cars.11.en' => 'string',
            'constants.cars.12.ar' => 'string',
            'constants.cars.12.en' => 'string',
            'constants.cars.13.ar' => 'string',
            'constants.cars.13.en' => 'string',
            'constants.cars.14.ar' => 'string',
            'constants.cars.14.en' => 'string',
            'constants.cars.15.ar' => 'string',
            'constants.cars.15.en' => 'string',
            'constants.cars.16.ar' => 'string',
            'constants.cars.16.en' => 'string',
            'constants.cars.17.ar' => 'string',
            'constants.cars.17.en' => 'string',
            'constants.cars.18.ar' => 'string',
            'constants.cars.18.en' => 'string',
            'constants.cars.19.ar' => 'string',
            'constants.cars.19.en' => 'string',
            'constants.cars.20.ar' => 'string',
            'constants.cars.20.en' => 'string',
            'constants.cars.21.ar' => 'string',
            'constants.cars.21.en' => 'string',
            'constants.cars.22.ar' => 'string',
            'constants.cars.22.en' => 'string',
            'constants.cars.23.ar' => 'string',
            'constants.cars.23.en' => 'string',
            'constants.cars.24.ar' => 'string',
            'constants.cars.24.en' => 'string',
            'constants.cars.25.ar' => 'string',
            'constants.cars.25.en' => 'string',
            'constants.cars.26.ar' => 'string',
            'constants.cars.26.en' => 'string',
            'constants.cars.27.ar' => 'string',
            'constants.cars.27.en' => 'string',
            'constants.cars.28.ar' => 'string',
            'constants.cars.28.en' => 'string',
            'constants.cars.29.ar' => 'string',
            'constants.cars.29.en' => 'string',
            'constants.cars.30.ar' => 'string',
            'constants.cars.30.en' => 'string',
            'constants.cars.31.ar' => 'string',
            'constants.cars.31.en' => 'string',
            'constants.cars.32.ar' => 'string',
            'constants.cars.32.en' => 'string',
            'constants.cars.33.ar' => 'string',
            'constants.cars.33.en' => 'string',
            'constants.cars.34.ar' => 'string',
            'constants.cars.34.en' => 'string',
            'constants.cars.35.ar' => 'string',
            'constants.cars.35.en' => 'string',
            'constants.cars.36.ar' => 'string',
            'constants.cars.36.en' => 'string',
            'constants.cars.37.ar' => 'string',
            'constants.cars.37.en' => 'string',
            'constants.cars.38.ar' => 'string',
            'constants.cars.38.en' => 'string',
            'constants.cars.39.ar' => 'string',
            'constants.cars.39.en' => 'string',
            'constants.cars.40.ar' => 'string',
            'constants.cars.40.en' => 'string',
            'constants.cars.41.ar' => 'string',
            'constants.cars.41.en' => 'string',
            'constants.cars.42.ar' => 'string',
            'constants.cars.42.en' => 'string',
            'constants.cars.43.ar' => 'string',
            'constants.cars.43.en' => 'string',
            'constants.cars.44.ar' => 'string',
            'constants.cars.44.en' => 'string',
            'constants.cars.45.ar' => 'string',
            'constants.cars.45.en' => 'string',
            'constants.session.upload_car_images' => 'string',
            'cors.paths' => 'array',
            ...
            'filesystems.links.C:\Users\beshe\OneDrive\Desktop\projects\cars-market\cars_market_laravel\public\storage' => 'string',
            'firebase.default' => 'string',
            'firebase.projects.app.credentials.type' => 'string',
            'firebase.projects.app.credentials.project_id' => 'string',
            'firebase.projects.app.credentials.private_key_id' => 'string',
            'firebase.projects.app.credentials.private_key' => 'string',
            'firebase.projects.app.credentials.client_email' => 'string',
            'firebase.projects.app.credentials.client_id' => 'string',
            'firebase.projects.app.credentials.auth_uri' => 'string',
            'firebase.projects.app.credentials.token_uri' => 'string',
            'firebase.projects.app.credentials.auth_provider_x509_cert_url' => 'string',
            'firebase.projects.app.credentials.client_x509_cert_url' => 'string',
            'firebase.projects.app.credentials.universe_domain' => 'string',
            ...
            'infobip-sms.driver' => 'string',
            'infobip-sms.from' => 'string',
            'infobip-sms.labsmobile.client' => 'string',
            'infobip-sms.labsmobile.username' => 'string',
            'infobip-sms.labsmobile.password' => 'string',
            'infobip-sms.labsmobile.test' => 'string',
            ...
            'otp.default_provider' => 'string',
            'otp.user_providers.users.table' => 'string',
            'otp.user_providers.users.model' => 'string',
            'otp.user_providers.users.repository' => 'string',
            'otp.mobile_column' => 'string',
            'otp.token_table' => 'string',
            'otp.token_length' => 'integer',
            'otp.token_lifetime' => 'integer',
            'otp.prefix' => 'string',
            'otp.sms_client' => 'string',
            'otp.token_storage' => 'string',
            'otp.channel' => 'string',
            ...
            'services.fcm.project_id' => 'string',
...
'app.providers','app.aliases.SMS','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'cloudinary.cloud_url','cloudinary.upload_preset','cloudinary.upload_route','cloudinary.upload_action','constants.cars.0.ar',
'constants.cars.0.en','constants.cars.1.ar','constants.cars.1.en','constants.cars.2.ar','constants.cars.2.en',
'constants.cars.3.ar','constants.cars.3.en','constants.cars.4.ar','constants.cars.4.en','constants.cars.5.ar',
'constants.cars.5.en','constants.cars.6.ar','constants.cars.6.en','constants.cars.7.ar','constants.cars.7.en',
'constants.cars.8.ar','constants.cars.8.en','constants.cars.9.ar','constants.cars.9.en','constants.cars.10.ar',
'constants.cars.10.en','constants.cars.11.ar','constants.cars.11.en','constants.cars.12.ar','constants.cars.12.en',
'constants.cars.13.ar','constants.cars.13.en','constants.cars.14.ar','constants.cars.14.en','constants.cars.15.ar',
'constants.cars.15.en','constants.cars.16.ar','constants.cars.16.en','constants.cars.17.ar','constants.cars.17.en',
'constants.cars.18.ar','constants.cars.18.en','constants.cars.19.ar','constants.cars.19.en','constants.cars.20.ar',
'constants.cars.20.en','constants.cars.21.ar','constants.cars.21.en','constants.cars.22.ar','constants.cars.22.en',
'constants.cars.23.ar','constants.cars.23.en','constants.cars.24.ar','constants.cars.24.en','constants.cars.25.ar',
'constants.cars.25.en','constants.cars.26.ar','constants.cars.26.en','constants.cars.27.ar','constants.cars.27.en',
'constants.cars.28.ar','constants.cars.28.en','constants.cars.29.ar','constants.cars.29.en','constants.cars.30.ar',
'constants.cars.30.en','constants.cars.31.ar','constants.cars.31.en','constants.cars.32.ar','constants.cars.32.en',
'constants.cars.33.ar','constants.cars.33.en','constants.cars.34.ar','constants.cars.34.en','constants.cars.35.ar',
'constants.cars.35.en','constants.cars.36.ar','constants.cars.36.en','constants.cars.37.ar','constants.cars.37.en',
'constants.cars.38.ar','constants.cars.38.en','constants.cars.39.ar','constants.cars.39.en','constants.cars.40.ar',
'constants.cars.40.en','constants.cars.41.ar','constants.cars.41.en','constants.cars.42.ar','constants.cars.42.en',
'constants.cars.43.ar','constants.cars.43.en','constants.cars.44.ar','constants.cars.44.en','constants.cars.45.ar',
'constants.cars.45.en','constants.session.upload_car_images','cors.paths','cors.allowed_methods','cors.allowed_origins',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.app.driver','filesystems.disks.app.root','filesystems.disks.app.throw',
'filesystems.links.C:\\Users\\beshe\\OneDrive\\Desktop\\projects\\cars-market\\cars_market_laravel\\public\\storage','firebase.default','firebase.projects.app.credentials.type','firebase.projects.app.credentials.project_id','firebase.projects.app.credentials.private_key_id',
'firebase.projects.app.credentials.private_key','firebase.projects.app.credentials.client_email','firebase.projects.app.credentials.client_id','firebase.projects.app.credentials.auth_uri','firebase.projects.app.credentials.token_uri',
'firebase.projects.app.credentials.auth_provider_x509_cert_url','firebase.projects.app.credentials.client_x509_cert_url','firebase.projects.app.credentials.universe_domain','firebase.projects.app.auth.tenant_id','firebase.projects.app.firestore',
...
'ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','ide-helper.macroable_traits','infobip-sms.driver','infobip-sms.from',
'infobip-sms.labsmobile.client','infobip-sms.labsmobile.username','infobip-sms.labsmobile.password','infobip-sms.labsmobile.test','logging.default',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','otp.default_provider',
'otp.user_providers.users.table','otp.user_providers.users.model','otp.user_providers.users.repository','otp.mobile_column','otp.token_table',
'otp.token_length','otp.token_lifetime','otp.prefix','otp.sms_client','otp.token_storage',
'otp.channel','permission.models.permission','permission.models.role','permission.table_names.roles','permission.table_names.permissions',
...
'services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.fcm.project_id','session.driver',
...
'typescript-transformer.formatter','typescript-transformer.transform_to_native_enums','typescript-transformer.transform_null_to_optional','broadcasting.default','broadcasting.connections.reverb.driver',
...
'l5-swagger.defaults.ui.authorization.persist_authorization','l5-swagger.defaults.ui.authorization.oauth2.use_pkce_with_authorization_code_grant','l5-swagger.defaults.constants.L5_SWAGGER_CONST_HOST','data.date_format','data.date_timezone',
